...
def main():
    ...
    parser.add_argument('flow_name', help='Name of the flow to be replaced with a language chooser.')
    parser.add_argument('output', help='RapidPro JSON file to write the output to.')
    parser.add_argument('sheet', help='Sheet defining the language chooser options. Either a csv file or a Google Sheet ID.')
    parser.add_argument('--format', required=True, choices=["csv", "google_sheets"], help='Format of the sheet.')
